...
public class GlobevntTestContainer extends TestContainer {

    public GlobevntTestContainer() {
        super();
    ...
    public static class Common extends GlobevntTestContainer {

        public static final GlobevntTestContainer.Common INSTANCE = new GlobevntTestContainer.Common();
